...
Минутка занудства. Ковариация показывает только прямое соотношение, то есть линейную зависимость, когда одна величина меняется пропорционально изменению другой.  
...
## Корреляция  
Если ковариация помогает определить связаны ли между собой две величины и направление этой связи, то корреляция помогает определить еще и силу этой связи.  
