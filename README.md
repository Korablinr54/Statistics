...
Этот репозиторий посвящён изучению статистики через Python и его библиотеки, а также отработке приёмов визуализации результатов расчётов.  

## Источники  

- Часть материала взята из бесплатного курса **"Основы статистики и A/B-тестирования"** от [Яндекс Практикум](https://start.practicum.yandex/statistics-basic/ ).  
...
Репозиторий содержит примеры кода, конспекты, задания и решения, которые помогут глубже понять основы статистического анализа и работы с данными в Python.  
...
- [Сравнение категорий](#сравнение-категорий)
...
Если в одном городе наблюдается высокая корреляция между количеством пожаров и количеством огнетушителей, это может быть связано с тем, что в более крупных городах больше пожаров (и, соответственно, больше огнетушителей). Но это не значит, что огнетушители вызывают пожары — скорее наоборот: их наличие связано с потребностью.  
